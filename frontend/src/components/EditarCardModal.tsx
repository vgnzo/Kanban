...
export default function EditarCardModal({ card, onSalvar, onCancelar }: EditarCardProps) {
  ...
  return (
    ...
    <div style={{
      ...
      {/* Container do Modal com altura máxima e Flexbox */}
      <div style={{
        width: '100%',
        maxWidth: '550px',
        maxHeight: '90vh', // 🟢 Limita a altura a 90% da tela
        display: 'flex',
        flexDirection: 'column', // 🟢 Mantém Cabeçalho, Corpo e Rodapé empilhados
        background: '#1a1a2e',
        ...
        {/* Corpo Rolável (Só o formulário rola se for grande) */}
        <div style={{
          padding: '24px',
          overflowY: 'auto', // 🟢 Rolagem interna caso os campos passem da altura
          flex: 1,
          display: 'flex',
        ...
        {/* Rodapé Fixo (O Botão de Salvar NUNCA SOME) */}
        <div style={{
          padding: '16px 24px',
          ...
          gap: '12px',
          flexShrink: 0 // 🟢 Impede o rodapé de ser esmagado
        }}>
          <button 
            onClick={onCancelar}
            style={{
